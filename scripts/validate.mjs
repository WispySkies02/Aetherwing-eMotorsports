...
assert(eventShareRoute.includes('/images/social/events/${event.shareSlug}-v45.jpg'), 'Schedule event shares use cache-busted v45 event-specific image cards');
...
assert(scheduleEvents.every((event) => existsSync(resolve(root, 'public/images/social/events', `${eventSlugForValidation(event)}-v45.jpg`))), 'All 143 schedule events have v45 share-card images');
