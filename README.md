> Current package: **v0.4.53** — Aetherwing Admin Control Center with direct live schedule delivery, verified one-step publishing, dynamic league choices, flexible charters, and sortable standings.

**Current release: v0.4.53 — Live Admin Schedule Delivery**
